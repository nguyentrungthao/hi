...
public:
  ...
  // điều khiển nhiệt
  void KhoiTao(TempCalibStruct_t xTempCalibStruct = {{37, 0.5}, {50, 0}, {60, 0}}, const uint16_t u16SizeEEprom = heaterEEPROM_SIZE);
  ...
  // cảm biến
  void CaiGiaTriOfset(TempCalibStruct_t);
  ...
  TempCalibStruct_t xGetCalibParamater() const;
...
private:
  ...
  void KhoiTaoCamBien(TempCalibStruct_t xTempCalibStruct = {{37, 0}, {50, 0}, {60, 0}});
  ...
  float fTinhGiaTriDauRaCamBien(Adafruit_MAX31865 &xPt100);
  void vTinhGiaTriABchoDuongCamBien(CalibData_t point1, CalibData_t point2, ParamterSensorlineOutput_t &ABParameter);
  ...
  // cảm biến 
  TempCalibStruct_t xTempCalibStruct = {};
  ParamterSensorlineOutput_t linePoint1Point2 = {};
  ParamterSensorlineOutput_t linePoint2Point3 = {};
  ...
  static void interuptACDET(void *ptr);
};
#endif
